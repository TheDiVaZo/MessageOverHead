...
public final class Bubble {
    ...
    public synchronized void show(Collection<Player> players) {
        show(players.toArray(Player[]::new));
    }
    ...
    public synchronized void hide(Collection<Player> players) {
        hide(players.toArray(Player[]::new));
    }
}
